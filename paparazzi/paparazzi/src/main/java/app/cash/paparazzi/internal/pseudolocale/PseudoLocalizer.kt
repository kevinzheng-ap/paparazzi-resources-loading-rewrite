...
import app.cash.paparazzi.internal.pseudolocale.Pseudolocalizer.Method.ACCENT
...
class PseudoMethodAccent : PseudoMethodImpl() {
  ...
  private fun processMaybePlaceholder(
    partial: StringBuilder, source: String, startIndex: Int
  ): Int {
...
fun String.pseudoLocalize(): String {
  return with(Pseudolocalizer(ACCENT)) {
